...
| `cpu.g_dcache.u_dcache.c_state_flush` | 3857 |
| `cpu.g_dcache.u_dcache.c_state_idle` | 985 |
...
| `cpu.g_dcache.u_dcache.c_trans_idle_to_flush` | 15 |
